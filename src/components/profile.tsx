...
export function Profile() {
  ...
  if (!wallet) return <div className="page profile-page"><h1>Profile</h1><div className="empty"><UserRound size={32} /><h2>Connect your account to open your profile.</h2><p>Your profile belongs to your passkey marketplace account.</p><button className="button primary" onClick={openWallet}>Connect account</button></div></div>;
