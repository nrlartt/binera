...
U temin yolları, Binance Agentic Wallet kurulumu, 8004scan API erişimi ve partnerlerin açık kanıt işleri: [partner-resources-tr.md](partner-resources-tr.md).
...
Bir Binera deploy'u passkey'i değiştirmez. Passkey işletim sistemi veya parola yöneticisinde, public hesap referansı ise aynı site origin'inin tarayıcı depolamasında bulunur. Uygulama bütün yerel hesap referanslarını saklar, eski tek-kayıt biçimini taşır ve yeni hesap açıldığında önceki kaydı ezmez. Sayfa yenilendiğinde son kaydedilen hesap oturumu passkey penceresi açılmadan otomatik geri gelir; imza gerektiren işlemde passkey onayı yine istenir. Kullanıcı **Disconnect this device session** seçerse otomatik dönüş, kayıtlı hesabı tekrar açana kadar kapalı kalır. **Export account references** dosyasını güvenli bir yerde tut. Bu dosyada özel anahtar yoktur fakat tek başına imza atamaz; passkey ayrıca cihazında kalmalıdır. Job export'u ayrı bir dosyadır.
